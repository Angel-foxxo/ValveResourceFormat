...
namespace GUI.Utils
{
    internal class ConsoleTab : IDisposable
    {
        ...
        private static readonly TextStyle TextStyleTime = new(new SolidBrush(MainForm.DarkModeCS.OScolors.TextActive), null, FontStyle.Regular);
        ...
        public TabPage CreateTab()
        {
            ...
            {
                BackColor = MainForm.DarkModeCS.OScolors.Surface,
                ForeColor = MainForm.DarkModeCS.OScolors.TextActive,
